...
if __name__ == '__main__':
    ...
    checkpoint_example_weights = 'checkpoints/0.weights'

    parser = argparse.ArgumentParser()
    parser.add_argument('--image_folder', type=str, default='data/proph/image/train/', help='path to dataset')
    ...
    # parser.add_argument('--weights_path', type=str, default=checkpoint_example_weights, help='path to weights file')
